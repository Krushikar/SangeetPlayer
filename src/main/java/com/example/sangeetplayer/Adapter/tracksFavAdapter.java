...
public class tracksFavAdapter extends RecyclerView.Adapter<tracksFavAdapter.ViewHolder> {

    private List<Song> songs;
    private OnClick onClick;

    public tracksFavAdapter(List<Song> songs, OnClick onClick){
        this.songs = songs;
    ...
    @NonNull
    @Override
    public tracksFavAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_tracks, parent, false);
        return new tracksFavAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull tracksFavAdapter.ViewHolder holder, int position) {
       ...
       holder.menu.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               popupMenu.getMenu().getItem(3).setTitle("Remove favourite");
