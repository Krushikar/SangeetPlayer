...
public class Ringtone_Fragment extends Fragment implements tracksAdapter.OnClick{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = getActivity().findViewById(R.id.recyle_ringtone);
